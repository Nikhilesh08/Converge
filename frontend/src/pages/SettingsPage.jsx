...
// FIX: Hardcoded to strictly light and dark to clean up the UI
  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4 max-w-2xl">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
                group flex flex-col items-center gap-2 p-3 rounded-xl transition-all border-2
                ${theme === t ? "border-primary bg-base-200" : "border-transparent hover:bg-base-200/50 hover:border-base-300"}
              `}
              onClick={() => setTheme(t)}
            >
              <div
            ...
            <div className="max-w-lg mx-auto">
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden border border-base-200">
                    ...
                    >
                      <div
                        className={`
                          ...
                          ${message.isSent ? "bg-primary text-primary-content rounded-tr-sm" : "bg-base-200 rounded-tl-sm"}
                        `}
                      >
                ...
                <div className="p-3 border-t border-base-300 bg-base-100">
                  <div className="flex gap-2 bg-base-200 rounded-full p-1 border border-base-300">
                    <input
                      type="text"
                      className="bg-transparent border-none focus:outline-none flex-1 text-sm h-10 px-4"
